...
class Flow_sheet1:
    baiku_csv_prefix = "scrm_dy_report_app_fxg_"
    account_name = input("请输入account_name：")
    s_date = "2023-08-01"
    e_date = "2023-09-30"
    baiku_csv_file = f"{baiku_csv_prefix}live_list_details_traffic_time_day.csv"
...
class Flow_sheet2:
    ...
    s_date = "2023-08-01"
    e_date = "2023-09-30"
    baiku_csv_file = f"{baiku_csv_prefix}live_detail_day.csv"
    baiku_df = pd.read_csv(baiku_csv_file)
...
def save_sheet2():
    投放金额 = Flow_sheet2.get_投放金额()
    投放转化金额 = Flow_sheet2.get_投放转化金额()
    直播间成交金额 = Flow_sheet2.get_直播间成交金额()
    ...
    try:
        ...
        export.sort_index().to_csv(f"{Flow_sheet2.account_name}_[流量表2].csv", encoding="utf-8", index=True)
        print(f"{Flow_sheet2.account_name}_[流量表2].csv ==> 保存成功")
    except Exception as e:
        print(e)


def save_sheet1():
    PV = Flow_sheet1.get_PV()
    自然PV = Flow_sheet1.get_自然PV()
    自然PV_率 = (自然PV / PV).apply(lambda x: format(x, ".9%")).dropna().replace(0, "0.00%")
    付费PV = Flow_sheet1.get_付费PV()
    付费PV_率 = (付费PV / PV).apply(lambda x: format(x, ".9%"))
    自然订单数 = Flow_sheet1.get_自然订单数()
    付费订单数 = Flow_sheet1.get_付费订单数()
    TTL订单数 = 自然订单数 + 付费订单数
    ...
    推荐feed渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="推荐feed")
    直播广场渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="直播广场")
    同城渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="同城")
    其他推荐场景渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="其他推荐场景")
    关注渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="关注")
    搜索渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="搜索")
    短视频引流渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="短视频引流")
    个人主页_店铺_橱窗PV = Flow_sheet1.get_指定渠道PV(filter_fields="个人主页&店铺&橱窗")
    抖音商城推荐PV = Flow_sheet1.get_指定渠道PV(filter_fields="抖音商城推荐")
    活动页渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="活动页")
    头条西瓜渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="头条西瓜")
    其他渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="其他")
    千川PC版渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="千川PC版")
    小店随心推渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="小店随心推")
    品牌广告渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="品牌广告")
    其他广告渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="其他广告")
    千川品牌广告渠道PV = Flow_sheet1.get_指定渠道PV(filter_fields="千川品牌广告")

    推荐feed渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="推荐feed")
    直播广场渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="直播广场")
    同城渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="同城")
    其他推荐场景渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="其他推荐场景")
    关注渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="关注")
    搜索渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="搜索")
    短视频引流渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="短视频引流")
    个人主页_店铺_橱窗GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="个人主页&店铺&橱窗")
    抖音商城推荐GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="抖音商城推荐")
    活动页渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="活动页")
    头条西瓜渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="头条西瓜")
    其他渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="其他")
    千川PC版渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="千川PC版")
    小店随心推渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="小店随心推")
    品牌广告渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="品牌广告")
    其他广告渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="其他广告")
    千川品牌广告渠道GMV = Flow_sheet1.get_指定渠道GMV(filter_fields="千川品牌广告")
    ...
    推荐feed渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="推荐feed")
    直播广场渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="直播广场")
    同城渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="同城")
    其他推荐场景渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="其他推荐场景")
    关注渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="关注")
    搜索渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="搜索")
    短视频引流渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="短视频引流")
    个人主页_店铺_橱窗订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="个人主页&店铺&橱窗")
    抖音商城推荐订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="抖音商城推荐")
    活动页渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="活动页")
    头条西瓜渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="头条西瓜")
    其他渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="其他")
    千川PC版渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="千川PC版")
    小店随心推渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="小店随心推")
    品牌广告渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="品牌广告")
    其他广告渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="其他广告")
    千川品牌广告渠道订单数 = Flow_sheet1.get_指定渠道订单数(filter_fields="千川品牌广告")
    ...
    try:
        ...
        export.to_csv(f"{Flow_sheet1.account_name}_[流量表1].csv")
        print(f"{Flow_sheet1.account_name}_[流量表1].csv ==> 保存成功")
    except Exception as e:
        print(e)
